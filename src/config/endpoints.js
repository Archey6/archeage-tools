export default {
  ...
  service: {
    ...
    item: 'https://api.archey.ca/api/item?ids=${itemIds}',
    itemCrops: '/service/items/crops',
    itemBuildings: 'https://api.archey.ca/api/items/buildings',
    ...
    vocations: 'https://api.archey.ca/api/vocations',
    searchByProduct: '/service/search/product',
    searchByMaterial: '/service/search/material',
    event: '/service/events/${eventId}',
    events: 'https://raw.githubusercontent.com/Archey6/archeage-tools/master/static/service/eventsDST.json',
    eventTypes: 'https://raw.githubusercontent.com/Archey6/archeage-tools/master/static/service/types.json',
    ...
    continents: 'https://api.archey.ca/api/continents',
    tradePacks: '/service/trade-packs',
    tradePackRef: '/service/trade-packs/reference',
    servers: 'https://api.archey.ca/api/servers',
